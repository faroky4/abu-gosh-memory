...
export default function PortalHero({ dict = defaultDict }: { dict?: HeroDict }) {
  return (
    <section className="bg-stone-50 border-b border-stone-200/60">
      <div className="max-w-4xl mx-auto px-5 sm:px-8 py-20 sm:py-28 text-center">
        ...
        <h1 className="text-4xl sm:text-5xl lg:text-6xl font-bold text-stone-900 mb-5 leading-tight">
          {dict.title}
        </h1>
